...
const UserManual: React.FC = () => {
  ...
  return (
    <div className="w-full mx-auto p-6 space-y-6">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    <li><strong>Встановлений норматив</strong> - введіть значення нормативу річних фінансових витрат на ЕУ 1 км дороги II категорії (наприклад, 604.761 тис. грн/км). Рік нормативу відображається в заголовку поля.</li>
                    <li><strong>Рік нормативу</strong> - вкажіть рік, в цінах якого встановлено норматив (наприклад, 2020). Якщо норматив 2020 року, а розрахунок ведеться на 2025 рік - введіть індекси інфляції за 2021-2025 роки.</li>
                  </ul>
                </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-lg mb-3">1. Введення базового нормативу:</h3>
                  <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    <li><strong>Встановлений норматив</strong> - введіть значення нормативу річних фінансових витрат на ЕУ 1 км дороги II категорії (наприклад, 360.544 тис. грн/км). Рік нормативу відображається в заголовку поля.</li>
                    <li><strong>Рік нормативу</strong> - вкажіть рік, в цінах якого встановлено норматив (наприклад, 2020). Якщо норматив 2020 року, а розрахунок ведеться на 2025 рік - введіть індекси інфляції за 2021-2025 роки.</li>
                  </ul>
                </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>❓ Часті питання (FAQ)</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
              <h3 className="font-semibold text-blue-900 mb-2">Як зберігаються мої дані?</h3>
              <p className="text-sm text-blue-800">
                Дані зберігаються локально у вашому браузері за допомогою IndexedDB. Це означає, що вони доступні тільки на цьому пристрої і в цьому браузері. 
                Для резервного копіювання регулярно експортуйте результати в Excel або PDF.
              </p>
            </div>

            <div className="p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
              <h3 className="font-semibold text-green-900 mb-2">Чи можу я працювати з декількома проектами одночасно?</h3>
              <p className="text-sm text-green-800">
                Так! Система автоматично створює окремі сесії для кожного набору розрахунків. Ви можете переглядати та порівнювати різні сесії в розділі "Історія розрахунків".
              </p>
            </div>

            <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
              <h3 className="font-semibold text-yellow-900 mb-2">Що робити, якщо я випадково закрив браузер під час роботи?</h3>
              <p className="text-sm text-yellow-800">
                Не хвилюйтеся! Система автоматично зберігає ваші зміни кожні 30 секунд. Просто відкрийте програму знову, і ваші дані будуть там. 
                Однак рекомендуємо регулярно натискати кнопку "Зберегти в сесію" після важливих розрахунків.
              </p>
            </div>

            <div className="p-4 bg-purple-50 rounded-lg border-l-4 border-purple-500">
              <h3 className="font-semibold text-purple-900 mb-2">Які формати файлів підтримуються для завантаження?</h3>
              <p className="text-sm text-purple-800 mb-2">
                <strong>Excel файли:</strong> .xlsx, .xls (максимум 10 MB)<br/>
                <strong>Документи:</strong> .pdf, .doc, .docx, .txt (для прикріплення до показників)<br/>
                <strong>Зображення:</strong> .jpg, .jpeg, .png (для схем та діаграм)
              </p>
            </div>

            <div className="p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
              <h3 className="font-semibold text-red-900 mb-2">Чому результати Q₁ і Q₂ не передаються в Розділ II?</h3>
              <p className="text-sm text-red-800">
                Переконайтеся, що ви натиснули кнопку <strong>"💾 Зберегти результати в сесію розрахунків"</strong> в Розділі I після виконання розрахунків. 
                Без збереження дані не передаються між розділами.
              </p>
            </div>

            <div className="p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500">
              <h3 className="font-semibold text-orange-900 mb-2">Як експортувати дані з усіх трьох розділів одночасно?</h3>
              <p className="text-sm text-orange-800">
                Перейдіть в розділ "Історія розрахунків", виберіть потрібну сесію, і використовуйте кнопку "Експортувати всю сесію в Excel". 
                Це створить файл з окремими аркушами для кожного розділу.
              </p>
            </div>

            <div className="p-4 bg-indigo-50 rounded-lg border-l-4 border-indigo-500">
              <h3 className="font-semibold text-indigo-900 mb-2">Чи можна змінити базові нормативи та коефіцієнти?</h3>
              <p className="text-sm text-indigo-800">
                Так, в Розділі II ви можете встановити власні нормативи та індекси інфляції. В Розділі III можна редагувати показники вартості дорожніх робіт. 
                Всі зміни автоматично враховуються в розрахунках.
              </p>
            </div>

            <div className="p-4 bg-teal-50 rounded-lg border-l-4 border-teal-500">
              <h3 className="font-semibold text-teal-900 mb-2">Що означає "Економічна доцільність" проекту?</h3>
              <p className="text-sm text-teal-800">
                Проект вважається економічно доцільним, якщо:<br/>
                • ENPV &gt; 0 (проект приносить чистий прибуток)<br/>
                • BCR &gt; 1.0 (вигоди більші за витрати)<br/>
                • EIRR &gt; 10% (норма дохідності вище мінімальної)<br/>
                Тільки такі проекти потрапляють до рангування на Сторінці 7.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>💡 Практичні приклади використання</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <h3 className="font-semibold text-lg mb-3 text-blue-900">Приклад 1: Розрахунок фінансування для державних доріг</h3>
            <div className="p-4 bg-blue-50 rounded-lg space-y-3">
              <div className="space-y-2">
                <p className="text-sm text-blue-900"><strong>Вихідні дані:</strong></p>
                <ul className="text-sm text-blue-800 list-disc list-inside ml-4">
                  <li>Q1 = 50,000,000 тис. грн (загальний бюджет)</li>
                  <li>Qпп = 2,500,000 тис. грн (пункти пропуску)</li>
                  <li>QІАС = 1,000,000 тис. грн (інформаційна система)</li>
                  <li>Інші показники = 500,000 тис. грн</li>
                </ul>
                <p className="text-sm text-blue-900 mt-3"><strong>Розрахунок:</strong></p>
                <p className="text-sm text-blue-800 font-mono bg-white p-2 rounded">
                  Q₁ = 50,000,000 + 2,500,000 + 1,000,000 + 500,000 = 54,000,000 тис. грн
                </p>
                <p className="text-sm text-blue-900 mt-3"><strong>Результат:</strong></p>
                <p className="text-sm text-blue-800">
                  Загальне фінансування державних доріг складає <strong>54 млрд грн</strong>, які будуть розподілені між регіонами відповідно до нормативів.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-3 text-green-900">Приклад 2: Розрахунок нормативу з урахуванням інфляції</h3>
            <div className="p-4 bg-green-50 rounded-lg space-y-3">
              <div className="space-y-2">
                <p className="text-sm text-green-900"><strong>Вихідні дані:</strong></p>
                <ul className="text-sm text-green-800 list-disc list-inside ml-4">
                  <li>Базовий норматив (2020): 604.761 тис. грн/км</li>
                  <li>Інфляція 2021: 10.0%</li>
                  <li>Інфляція 2022: 26.6%</li>
                  <li>Інфляція 2023: 12.5%</li>
                </ul>
                <p className="text-sm text-green-900 mt-3"><strong>Розрахунок:</strong></p>
                <div className="text-sm text-green-800 font-mono bg-white p-3 rounded space-y-1">
                  <div>Норматив 2021 = 604.761 × (1 + 0.10) = 665.237 тис. грн/км</div>
                  <div>Норматив 2022 = 665.237 × (1 + 0.266) = 842.190 тис. грн/км</div>
                  <div>Норматив 2023 = 842.190 × (1 + 0.125) = 947.464 тис. грн/км</div>
                </div>
                <p className="text-sm text-green-900 mt-3"><strong>Результат:</strong></p>
                <p className="text-sm text-green-800">
                  Актуальний норматив для доріг II категорії в 2023 році: <strong>947.464 тис. грн/км</strong>
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-3 text-purple-900">Приклад 3: Визначення необхідного виду робіт</h3>
            <div className="p-4 bg-purple-50 rounded-lg space-y-3">
              <div className="space-y-2">
                <p className="text-sm text-purple-900"><strong>Дорога М-06, ділянка 50 км:</strong></p>
                <div className="grid grid-cols-2 gap-3 mt-2">
                  <div className="bg-white p-3 rounded">
                    <p className="text-xs text-gray-600">Фактична інтенсивність:</p>
                    <p className="text-lg font-bold text-purple-900">18,000 авт/добу</p>
                  </div>
                  <div className="bg-white p-3 rounded">
                    <p className="text-xs text-gray-600">Розрахункова інтенсивність:</p>
                    <p className="text-lg font-bold text-purple-900">15,000 авт/добу</p>
                  </div>
                  <div className="bg-white p-3 rounded">
                    <p className="text-xs text-gray-600">Модуль пружності:</p>
                    <p className="text-lg font-bold text-purple-900">180 МПа</p>
                  </div>
                  <div className="bg-white p-3 rounded">
                    <p className="text-xs text-gray-600">Норматив міцності:</p>
                    <p className="text-lg font-bold text-purple-900">200 МПа</p>
                  </div>
                </div>
                <p className="text-sm text-purple-900 mt-3"><strong>Розрахунок коефіцієнтів:</strong></p>
                <div className="text-sm text-purple-800 bg-white p-3 rounded space-y-1">
                  <div>K<sub>інт</sub> = 18,000 / 15,000 = 1.20 ✅ (в нормі)</div>
                  <div>K<sub>міц</sub> = 180 / 200 = 0.90 ⚠️ (нижче норми)</div>
                </div>
                <Alert className="bg-yellow-50 border-yellow-300 mt-3">
                  <AlertCircle className="h-4 w-4 text-yellow-600" />
                  <AlertDescription className="text-yellow-800">
                    <strong>Висновок:</strong> Оскільки K<sub>міц</sub> &lt; 1.0, необхідний <strong>КАПІТАЛЬНИЙ РЕМОНТ</strong>. 
                    Орієнтовна вартість: 12,000 тис. грн/км × 50 км = <strong>600,000 тис. грн (600 млн грн)</strong>
                  </AlertDescription>
                </Alert>
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>⚡ Поради з оптимізації роботи</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <ul className="text-sm text-green-800 space-y-2">
                <li>• При завантаженні даних по 24 областях використовуйте фільтр "Всі області" тільки для підсумків</li>
                <li>• Для детального аналізу вибирайте конкретну область</li>
                <li>• Розбивайте великі файли Excel на декілька менших (по регіонах)</li>
                <li>• Закривайте непотрібні вкладки браузера для прискорення</li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="text-sm text-blue-800 space-y-2">
                <li>• Використовуйте клавішу Tab для переходу між полями</li>
                <li>• Ctrl+C / Ctrl+V працюють в таблицях (можна копіювати з Excel)</li>
                <li>• Десяткові числа вводьте через крапку (не кому): 12.5</li>
                <li>• Для великих чисел використовуйте формат без пробілів: 1000000</li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <ul className="text-sm text-purple-800 space-y-2">
                <li>• Створіть шаблонні Excel файли для регулярних розрахунків</li>
                <li>• Зберігайте типові набори показників в окремих сесіях</li>
                <li>• Використовуйте копіювання сесій для схожих проектів</li>
                <li>• Експортуйте результати одразу після розрахунку</li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-orange-50 rounded-lg">
              ...
              <ul className="text-sm text-orange-800 space-y-2">
                <li>• Використовуйте зрозумілі назви для доріг: "М-06 км 0-50"</li>
                <li>• Додавайте дати до експортованих файлів: "Розрахунок_2024_Q1"</li>
                <li>• Створюйте окремі папки на комп'ютері для кожного року</li>
                <li>• Ведіть журнал змін нормативів у текстовому файлі</li>
              </ul>
            </div>
          </div>
          ...
          <Alert className="bg-indigo-50 border-indigo-300">
            ...
            <AlertTitle className="text-indigo-900">💼 Професійна порада</AlertTitle>
            <AlertDescription className="text-indigo-800">
              Створіть робочий процес: <strong>Введення даних → Розрахунок → Збереження в сесію → Експорт в Excel → Перевірка результатів</strong>. 
              Дотримуйтесь цієї послідовності для кожного розділу, щоб уникнути втрати даних.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>📚 Глосарій термінів та абревіатур</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-3">
            {[
              { term: 'ENPV', desc: 'Економічна чиста приведена вартість (Economic Net Present Value) - показник економічної ефективності проекту, що враховує дисконтування грошових потоків' },
              { term: 'EIRR', desc: 'Економічна внутрішня норма дохідності (Economic Internal Rate of Return) - ставка дисконтування, при якій ENPV = 0' },
              { term: 'BCR', desc: 'Співвідношення вигід до витрат (Benefit-Cost Ratio) - показник рентабельності, що відображає відношення приведеної вартості вигід до витрат' },
              { term: 'Q₁', desc: 'Обсяг бюджетного фінансування автомобільних доріг державного значення (тис. грн)' },
              { term: 'Q₂', desc: 'Обсяг бюджетного фінансування автомобільних доріг місцевого значення (тис. грн)' },
              { term: 'ЕУ', desc: 'Експлуатаційне утримання - комплекс робіт для підтримання доріг у належному стані' },
              { term: 'K_інт', desc: 'Коефіцієнт інтенсивності руху - відношення фактичної інтенсивності до розрахункової' },
              { term: 'K_міц', desc: 'Коефіцієнт міцності - відношення фактичного модуля пружності до нормативного' },
              { term: 'K_рів', desc: 'Коефіцієнт рівності покриття - відношення нормативної рівності до фактичної' },
              { term: 'МПП', desc: 'Міжнародні пункти пропуску через державний кордон України' },
              { term: 'ІАС', desc: 'Інформаційно-аналітична система управління дорожнім господарством' },
              { term: 'ДПП', desc: 'Державно-приватне партнерство - форма співпраці держави з приватним сектором' },
              { term: 'Модуль пружності', desc: 'Показник міцності дорожнього покриття, вимірюється в МПа (мегапаскалях)' },
              { term: 'Глибина колії', desc: 'Вертикальна деформація дорожнього покриття від проходження транспорту, вимірюється в мм' },
              { term: 'Коеф. зчеплення', desc: 'Показник протиковзких властивостей покриття, безрозмірна величина від 0 до 1' },
              { term: 'Капітальний ремонт', desc: 'Комплекс робіт для відновлення міцності дорожнього покриття' },
              { term: 'Поточний ремонт', desc: 'Роботи для усунення дрібних дефектів покриття (ямковість, колійність, тріщини)' },
              { term: 'Реконструкція', desc: 'Комплекс робіт для зміни технічної категорії дороги, збільшення пропускної здатності' },
              { term: 'Норматив фінансування', desc: 'Встановлена величина витрат на утримання 1 км дороги певної категорії за рік' },
              { term: 'Індекс інфляції', desc: 'Показник зростання цін, що використовується для коригування нормативів' },
              { term: 'Ставка дисконтування', desc: 'Процентна ставка для приведення майбутніх грошових потоків до поточної вартості (зазвичай 10%)' },
              { term: 'Сесія розрахунків', desc: 'Набір пов\'язаних даних з усіх трьох розділів, що зберігається як єдиний проект' },
              { term: 'IndexedDB', desc: 'Сховище даних у браузері для збереження великих обсягів структурованої інформації' },
              { term: 'Категорія дороги', desc: 'Технічна класифікація доріг від I до V залежно від інтенсивності руху та значення' },
              { term: 'Рангування', desc: 'Процес визначення пріоритетності дорожніх проектів на основі економічної ефективності' }
            ].map((item, i) => (
      ...
      <Card className="border-2 border-green-500">
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            Якщо у вас виникли питання, знайдені помилки, або у вас є пропозиції щодо покращення системи, будь ласка, зв'яжіться з технічною підтримкою.
          </p>
          
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              <h3 className="font-semibold text-blue-900 mb-2">📧 Повідомити про помилку</h3>
              <p className="text-sm text-blue-800">
                При повідомленні про помилку, будь ласка, вкажіть:
              </p>
              <ul className="text-sm text-blue-800 list-disc list-inside mt-2 space-y-1">
                <li>Розділ, де виникла помилка</li>
                <li>Що ви робили перед помилкою</li>
                <li>Текст повідомлення про помилку</li>
                <li>Скріншот екрану (якщо можливо)</li>
              </ul>
            </div>

            <div className="p-4 bg-purple-50 rounded-lg">
              <h3 className="font-semibold text-purple-900 mb-2">💡 Запропонувати покращення</h3>
              <p className="text-sm text-purple-800">
                Ваші ідеї допомагають покращувати систему! Ділитеся:
              </p>
              <ul className="text-sm text-purple-800 list-disc list-inside mt-2 space-y-1">
                <li>Ідеями нових функцій</li>
                <li>Зауваженнями щодо зручності</li>
                <li>Побажаннями до інтерфейсу</li>
                <li>Пропозиціями щодо звітів</li>
              </ul>
            </div>
          </div>
          ...
          <Alert className="bg-yellow-50 border-yellow-300">
            ...
            <AlertDescription className="text-yellow-800">
              <strong>📌 Примітка:</strong> Регулярно перевіряйте наявність оновлень системи. Нові версії містять виправлення помилок та нові функції.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
